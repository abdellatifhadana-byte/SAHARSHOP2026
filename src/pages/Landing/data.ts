...
export const LX: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    seoTitle: 'AMANZINE — منصّة المغرب الذكية للبيع والخدمات', seoDesc: 'أنشئ متجرك الإلكتروني، اعرض خدماتك، وبِع في السوق المغربي الموحّد — مع ذكاء اصطناعي وتوصيل آلي. مجاني للبدء.',
  ...
  darija: {
    ...
    seoTitle: 'AMANZINE — منصّة المغرب الذكية للبيع والخدمات', seoDesc: 'دير متجرك، قدّم خدماتك، وبيع ف السوق المغربي الموحّد — مع ذكاء اصطناعي وتوصيل أوتوماتيك. بلاش باش تبدا.',
  ...
  fr: {
    ...
    seoTitle: 'AMANZINE — la plateforme commerce intelligente du Maroc', seoDesc: 'Créez votre boutique, proposez vos services et vendez sur le Souk marocain unifié — avec IA et livraison automatique. Gratuit pour démarrer.',
  ...
  en: {
    ...
    seoTitle: 'AMANZINE — Morocco’s smart commerce platform', seoDesc: 'Create your online store, offer services and sell on Morocco’s unified market — with AI and automatic delivery. Free to start.',
  ...
  zh: {
    ...
    seoTitle: 'AMANZINE — 摩洛哥智能商业平台', seoDesc: '创建在线店铺、提供服务并在摩洛哥统一市场销售 — 配备 AI 与自动配送。免费开始。',
